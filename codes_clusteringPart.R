# The organized codes for the knotweed performance across ranges and trait variation
...
# the dataframe containing the basic information for the populations and functions traits
# Dataset is freely accessible from: https://doi.org/10.5281/zenodo.14603581.
...
# data - this table is just a organized version of the dataset from: https://doi.org/10.5281/zenodo.14603581

# The other two files are needed for the mapping section in this document
# they are from public database: gadm
